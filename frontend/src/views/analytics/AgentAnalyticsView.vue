        ...
        <div v-if="!error" class="grid gap-4 md:grid-cols-2 lg:grid-cols-5">
          ...
          <template v-else-if="analytics">
            ...
            <div class="card-depth rounded-xl border border-white/[0.08] bg-white/[0.04] p-6 light:bg-white light:border-gray-200">
              <div class="flex flex-row items-center justify-between space-y-0 pb-2">
                <span class="text-sm font-medium text-[var(--text-muted)]">{{ $t('agentAnalytics.transfersHandled') }}</span>
              ...
              <div class="pt-2">
                ...
                <p class="text-xs text-[var(--text-muted)] mt-1">{{ $t('agentAnalytics.completedConversations') }}</p>
              </div>
            </div>
            ...
            <div class="card-depth rounded-xl border border-white/[0.08] bg-white/[0.04] p-6 light:bg-white light:border-gray-200">
              <div class="flex flex-row items-center justify-between space-y-0 pb-2">
                <span class="text-sm font-medium text-[var(--text-muted)]">{{ $t('agentAnalytics.activeConversations') }}</span>
              ...
              <div class="pt-2">
                ...
                <p class="text-xs text-[var(--text-muted)] mt-1">{{ $t('agentAnalytics.currentlyInProgress') }}</p>
              </div>
            </div>
            ...
            <div class="card-depth rounded-xl border border-white/[0.08] bg-white/[0.04] p-6 light:bg-white light:border-gray-200">
              <div class="flex flex-row items-center justify-between space-y-0 pb-2">
                <span class="text-sm font-medium text-[var(--text-muted)]">{{ $t('agentAnalytics.avgResolutionTime') }}</span>
              ...
              <div class="pt-2">
                ...
                <p class="text-xs text-[var(--text-muted)] mt-1">{{ $t('agentAnalytics.timeToResolve') }}</p>
              </div>
            </div>
            ...
            <div v-if="isAdminOrManager && selectedAgentId === 'all'" class="card-depth rounded-xl border border-white/[0.08] bg-white/[0.04] p-6 light:bg-white light:border-gray-200">
              <div class="flex flex-row items-center justify-between space-y-0 pb-2">
                <span class="text-sm font-medium text-[var(--text-muted)]">{{ $t('agentAnalytics.avgQueueTime') }}</span>
              ...
              <div class="pt-2">
                ...
                <p class="text-xs text-[var(--text-muted)] mt-1">{{ $t('agentAnalytics.waitBeforeAssignment') }}</p>
              </div>
            </div>
            <div v-else class="card-depth rounded-xl border border-white/[0.08] bg-white/[0.04] p-6 light:bg-white light:border-gray-200">
              <div class="flex flex-row items-center justify-between space-y-0 pb-2">
                <span class="text-sm font-medium text-[var(--text-muted)]">{{ $t('agentAnalytics.messagesSent') }}</span>
                <div class="h-10 w-10 rounded-lg bg-purple-500/20 flex items-center justify-center">
              ...
              <div class="pt-2">
                ...
                <p class="text-xs text-[var(--text-muted)] mt-1">{{ $t('agentAnalytics.outgoingMessages') }}</p>
              </div>
            </div>
            ...
            <div class="card-depth rounded-xl border border-white/[0.08] bg-white/[0.04] p-6 light:bg-white light:border-gray-200">
              <div class="flex flex-row items-center justify-between space-y-0 pb-2">
                <span class="text-sm font-medium text-[var(--text-muted)]">{{ $t('agentAnalytics.breakTime') }}</span>
