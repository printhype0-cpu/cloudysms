      ...
      <div class="p-6 space-y-6">
        ...
        <Tabs v-if="!error" v-model="activeTab" class="w-full">
            ...
            <template v-if="isLoading">
              <div class="grid gap-4 md:grid-cols-3">
                <div v-for="i in 3" :key="i" class="rounded-xl border border-white/[0.08] bg-white/[0.02] p-6 light:bg-white light:border-gray-200">
                  <Skeleton class="h-4 w-24 mb-2 bg-[var(--glass-border)]" />
                  <Skeleton class="h-8 w-16 bg-[var(--glass-border)]" />
                </div>
              </div>
            </template>
              ...
              <div class="grid gap-4 md:grid-cols-3">
                <div class="card-depth rounded-xl border border-white/[0.08] bg-white/[0.04] p-6 light:bg-white light:border-gray-200">
                  <div class="flex flex-row items-center justify-between space-y-0 pb-2">
                    <span class="text-sm font-medium text-[var(--text-muted)]">{{ $t('metaInsights.messagesSent') }}</span>
                ...
                <div class="card-depth rounded-xl border border-white/[0.08] bg-white/[0.04] p-6 light:bg-white light:border-gray-200">
                  <div class="flex flex-row items-center justify-between space-y-0 pb-2">
                    <span class="text-sm font-medium text-[var(--text-muted)]">{{ $t('metaInsights.messagesDelivered') }}</span>
                    <div class="h-10 w-10 rounded-lg bg-emerald-500/20 flex items-center justify-center">
                      <CheckCircle class="h-5 w-5 text-[var(--primary-color)]" />
                    </div>
                  </div>
                  <div class="pt-2">
                    <div class="text-3xl font-bold text-[var(--text-main)]">
                ...
                <div class="card-depth rounded-xl border border-white/[0.08] bg-white/[0.04] p-6 light:bg-white light:border-gray-200">
                  <div class="flex flex-row items-center justify-between space-y-0 pb-2">
                    <span class="text-sm font-medium text-[var(--text-muted)]">{{ $t('metaInsights.deliveryRate') }}</span>
          ...
          <TabsContent value="pricing_analytics" class="space-y-6">
            <template v-if="isLoading">
              <Skeleton class="h-64 bg-[var(--glass-border)]" />
            </template>
            <template v-else-if="aggregatedData && activeTab === 'pricing_analytics'">
              ...
              <div class="grid gap-4 md:grid-cols-2">
                <div class="card-depth rounded-xl border border-white/[0.08] bg-white/[0.04] p-6 light:bg-white light:border-gray-200">
                  <div class="flex flex-row items-center justify-between space-y-0 pb-2">
                    <span class="text-sm font-medium text-[var(--text-muted)]">{{ $t('metaInsights.totalMessages') }}</span>
                    <div class="h-10 w-10 rounded-lg bg-blue-500/20 flex items-center justify-center">
                ...
                <div class="card-depth rounded-xl border border-white/[0.08] bg-white/[0.04] p-6 light:bg-white light:border-gray-200">
                  <div class="flex flex-row items-center justify-between space-y-0 pb-2">
                    <span class="text-sm font-medium text-[var(--text-muted)]">{{ $t('metaInsights.totalCost') }}</span>
                    <div class="h-10 w-10 rounded-lg bg-emerald-500/20 flex items-center justify-center">
                      <DollarSign class="h-5 w-5 text-[var(--primary-color)]" />
                    </div>
                  </div>
                  <div class="pt-2">
                    <div class="text-3xl font-bold text-[var(--text-main)]">
                  ...
                  <CardContent>
                    <div class="space-y-3">
                      <div class="flex items-center justify-between py-2 border-b border-white/[0.08] light:border-gray-100">
                        <span class="text-sm text-[var(--text-main)]">{{ $t('metaInsights.freeCustomerService') }}</span>
                        <span class="font-semibold text-[var(--text-main)]">{{ (aggregatedData as ReturnType<typeof aggregatePricingData>).freeMessages.customerService.toLocaleString() }}</span>
                      </div>
                      <div class="flex items-center justify-between py-2 border-b border-white/[0.08] light:border-gray-100">
                        <span class="text-sm text-[var(--text-main)]">{{ $t('metaInsights.freeEntryPoint') }}</span>
                        <span class="font-semibold text-[var(--text-main)]">{{ (aggregatedData as ReturnType<typeof aggregatePricingData>).freeMessages.entryPoint.toLocaleString() }}</span>
                      </div>
                  ...
                  <CardContent>
                    <div class="space-y-3">
                      <div v-for="(count, category) in (aggregatedData as ReturnType<typeof aggregatePricingData>).paidMessages.byCategory" :key="category" class="flex items-center justify-between py-2 border-b border-white/[0.08] light:border-gray-100 last:border-0">
                        <span class="text-sm text-[var(--text-main)]">{{ formatCategory(category as string) }}</span>
                        <span class="font-semibold text-[var(--text-main)]">{{ (count as number).toLocaleString() }}</span>
                      </div>
                      <div v-if="Object.keys((aggregatedData as ReturnType<typeof aggregatePricingData>).paidMessages.byCategory).length === 0" class="text-center text-[var(--text-muted)] py-4">
                  ...
                  <CardContent>
                    <div class="space-y-3">
                      <div v-for="(cost, category) in (aggregatedData as ReturnType<typeof aggregatePricingData>).costByCategory" :key="category" class="flex items-center justify-between py-2 border-b border-white/[0.08] light:border-gray-100 last:border-0">
                        <span class="text-sm text-[var(--text-main)]">{{ formatCategory(category as string) }}</span>
                        <span class="font-semibold text-[var(--text-main)]">{{ formatCurrency(cost as number) }}</span>
                      </div>
                      <div class="flex items-center justify-between py-2 bg-emerald-500/10 rounded px-2 -mx-2">
                        <span class="text-sm font-medium text-[var(--primary-color)] light:text-emerald-600">{{ $t('metaInsights.totalCost') }}</span>
                        <span class="font-bold text-[var(--primary-color)] light:text-emerald-600">{{ formatCurrency((aggregatedData as ReturnType<typeof aggregatePricingData>).totals.cost) }}</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent>
                    <div class="space-y-3">
                      <div v-for="(data, country) in (aggregatedData as ReturnType<typeof aggregatePricingData>).byCountry" :key="country" class="flex items-center justify-between py-2 border-b border-white/[0.08] light:border-gray-100 last:border-0">
                        <span class="text-sm text-[var(--text-main)]">{{ country }}</span>
                        <div class="text-right">
                          <span class="font-semibold text-[var(--text-main)]">{{ (data as {volume: number, cost: number}).volume.toLocaleString() }} {{ $t('metaInsights.msgs') }}</span>
                          <span class="text-[var(--text-muted)] ml-2">{{ formatCurrency((data as {volume: number, cost: number}).cost) }}</span>
                        </div>
                      </div>
                    </div>
                  </CardContent>
          ...
          <TabsContent value="template_analytics" class="space-y-6">
            ...
            <template v-else-if="aggregatedData && activeTab === 'template_analytics'">
              ...
              <div class="grid gap-4 md:grid-cols-6">
                <div class="card-depth rounded-xl border border-white/[0.08] bg-white/[0.04] p-6 light:bg-white light:border-gray-200">
                  <div class="flex flex-row items-center justify-between space-y-0 pb-2">
                    <span class="text-sm font-medium text-[var(--text-muted)]">{{ $t('metaInsights.sent') }}</span>
                    <div class="h-10 w-10 rounded-lg bg-blue-500/20 flex items-center justify-center">
                      <Send class="h-5 w-5 text-blue-400" />
                    </div>
                  </div>
                ...
                <div class="card-depth rounded-xl border border-white/[0.08] bg-white/[0.04] p-6 light:bg-white light:border-gray-200">
                  <div class="flex flex-row items-center justify-between space-y-0 pb-2">
                    <span class="text-sm font-medium text-[var(--text-muted)]">{{ $t('metaInsights.delivered') }}</span>
                    <div class="h-10 w-10 rounded-lg bg-emerald-500/20 flex items-center justify-center">
                      <CheckCircle class="h-5 w-5 text-[var(--primary-color)]" />
                    </div>
                  </div>
                ...
                <div class="card-depth rounded-xl border border-white/[0.08] bg-white/[0.04] p-6 light:bg-white light:border-gray-200">
                  <div class="flex flex-row items-center justify-between space-y-0 pb-2">
                    <span class="text-sm font-medium text-[var(--text-muted)]">{{ $t('metaInsights.read') }}</span>
                    <div class="h-10 w-10 rounded-lg bg-purple-500/20 flex items-center justify-center">
                ...
                <div class="card-depth rounded-xl border border-white/[0.08] bg-white/[0.04] p-6 light:bg-white light:border-gray-200">
                  <div class="flex flex-row items-center justify-between space-y-0 pb-2">
                    <span class="text-sm font-medium text-[var(--text-muted)]">{{ $t('metaInsights.replied') }}</span>
                ...
                <div class="card-depth rounded-xl border border-white/[0.08] bg-white/[0.04] p-6 light:bg-white light:border-gray-200">
                  <div class="flex flex-row items-center justify-between space-y-0 pb-2">
                    <span class="text-sm font-medium text-[var(--text-muted)]">{{ $t('metaInsights.clicked') }}</span>
          ...
          <TabsContent value="call_analytics" class="space-y-6">
            ...
            <template v-else-if="aggregatedData && activeTab === 'call_analytics'">
              ...
              <div class="grid gap-4 md:grid-cols-5">
                <div class="card-depth rounded-xl border border-white/[0.08] bg-white/[0.04] p-6 light:bg-white light:border-gray-200">
                  <div class="flex flex-row items-center justify-between space-y-0 pb-2">
                    <span class="text-sm font-medium text-[var(--text-muted)]">{{ $t('metaInsights.totalCalls') }}</span>
                    <div class="h-10 w-10 rounded-lg bg-blue-500/20 flex items-center justify-center">
                ...
                <div class="card-depth rounded-xl border border-white/[0.08] bg-white/[0.04] p-6 light:bg-white light:border-gray-200">
                  <div class="flex flex-row items-center justify-between space-y-0 pb-2">
                    <span class="text-sm font-medium text-[var(--text-muted)]">{{ $t('metaInsights.incoming') }}</span>
                    <div class="h-10 w-10 rounded-lg bg-blue-500/20 flex items-center justify-center">
                ...
                <div class="card-depth rounded-xl border border-white/[0.08] bg-white/[0.04] p-6 light:bg-white light:border-gray-200">
                  <div class="flex flex-row items-center justify-between space-y-0 pb-2">
                    <span class="text-sm font-medium text-[var(--text-muted)]">{{ $t('metaInsights.outgoing') }}</span>
                    <div class="h-10 w-10 rounded-lg bg-purple-500/20 flex items-center justify-center">
                ...
                <div class="card-depth rounded-xl border border-white/[0.08] bg-white/[0.04] p-6 light:bg-white light:border-gray-200">
                  <div class="flex flex-row items-center justify-between space-y-0 pb-2">
                    <span class="text-sm font-medium text-[var(--text-muted)]">{{ $t('metaInsights.avgDuration') }}</span>
                    <div class="h-10 w-10 rounded-lg bg-emerald-500/20 flex items-center justify-center">
                      <TrendingUp class="h-5 w-5 text-[var(--primary-color)]" />
                    </div>
                  </div>
                  <div class="pt-2">
                    <div class="text-3xl font-bold text-[var(--text-main)]">
